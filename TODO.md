...
- Улучшить систему ввода(добавить буффер, как минимум)
- Добавить формат символа и числа с плавающей точкой.
...
работа с памятью -> файловая система -> таймер -> многозадачность -> системные вызовы -> улучшение и полировка.  
Попутно исправлять возникающие ошибки и перерабатывать некоторые функции.  
Отдельно заниматься комментированием кода.